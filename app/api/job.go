...
// @router  /system/organize/job/info [GET]
...
// @router  /system/organize/job/lists [GET]
// @success 200 {object} response.JsonResponse "执行结果"
...
// @router  /system/organize/job/create [POST]
// @success 200 {object} response.JsonResponse "执行结果"
...
// @router  /system/organize/job/modify [POST]
// @success 200 {object} response.JsonResponse "执行结果"
...
// @router  /system/organize/job/delete [DELETE]
// @success 200 {object} response.JsonResponse "执行结果"
