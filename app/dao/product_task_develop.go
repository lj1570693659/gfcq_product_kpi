...
// internalProductTaskDevelopDao is internal type for wrapping internal DAO implements.
type internalProductTaskDevelopDao = *internal.ProductTaskDevelopDao
...
type productTaskDevelopDao struct {
	internalProductTaskDevelopDao
}

var (
	// ProductTaskDevelop is globally public accessible object for table cqgf_product_task_develop operations.
	ProductTaskDevelop = productTaskDevelopDao{
		internal.NewProductTaskDevelopDao(),
	}
)

// Fill with you ideas below.
func (s *productTaskDevelopDao) GetAll(ctx context.Context, in *entity.ProductTaskDevelop) (res []*model.ProductTaskDevelopField, err error) {
	res = make([]*model.ProductTaskDevelopField, 0)
	query := s.Ctx(ctx)
	// 项目经理投入程度
	if in.Id > 0 {
...
func (s *productTaskDevelopDao) GetUpgradeAll(ctx context.Context, in *entity.ProductTaskDevelop) (res []*model.ProductTaskDevelopField, err error) {
	res = make([]*model.ProductTaskDevelopField, 0)
...
func (s *productTaskDevelopDao) GetList(ctx context.Context, in *model.ProductTaskWhere) (res *response.GetListResponse, err error) {
	res = &response.GetListResponse{}
	resData := make([]*model.ProductTaskDevelopField, 0)
...
func (s *productTaskDevelopDao) GetOne(ctx context.Context, in *model.ProductTaskWhere) (res model.ProductTaskDevelopField, err error) {
	productEntity := model.ProductTaskDevelopField{}
	query := s.Ctx(ctx)
	// 项目名称
	if len(in.TaskName) > 0 {
...
// Modify 编辑项目基础数据
func (s *productTaskDevelopDao) Modify(ctx context.Context, in model.ProductTaskDevelopField) (model.ProductTaskDevelopField, error) {
	data := do.ProductTaskDevelop{}
