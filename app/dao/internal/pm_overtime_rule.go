...
type PmOvertimeRuleDao struct {
	...
	columns PmOvertimeRuleColumns // columns contains all the column names of Table for convenient usage.
}
...
// pmOvertimeRuleColumns holds the columns for table cqgf_pm_overtime_rule.
var pmOvertimeRuleColumns = PmOvertimeRuleColumns{
	Id:         "id",
	Redio:      "redio",
	ScoreMin:   "score_min",
	ScoreMax:   "score_max",
...
func NewPmOvertimeRuleDao() *PmOvertimeRuleDao {
	return &PmOvertimeRuleDao{
		group:   "default",
		table:   "cqgf_pm_overtime_rule",
		columns: pmOvertimeRuleColumns,
	}
}
...
func (dao *PmOvertimeRuleDao) Columns() PmOvertimeRuleColumns {
	return dao.columns
}
