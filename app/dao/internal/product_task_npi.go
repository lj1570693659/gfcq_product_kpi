...
type ProductTaskNpiDao struct {
	...
	columns ProductTaskNpiColumns // columns contains all the column names of Table for convenient usage.
}
...
// productTaskNpiColumns holds the columns for table cqgf_product_task_npi.
var productTaskNpiColumns = ProductTaskNpiColumns{
	Id:                  "id",
...
func NewProductTaskNpiDao() *ProductTaskNpiDao {
	return &ProductTaskNpiDao{
		group:   "default",
		table:   "cqgf_product_task_npi",
		columns: productTaskNpiColumns,
	}
}
...
func (dao *ProductTaskNpiDao) Columns() ProductTaskNpiColumns {
	return dao.columns
}
