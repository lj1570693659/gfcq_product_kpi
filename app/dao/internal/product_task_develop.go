...
type ProductTaskDevelopDao struct {
	...
	columns ProductTaskDevelopColumns // columns contains all the column names of Table for convenient usage.
}
...
// productTaskDevelopColumns holds the columns for table cqgf_product_task_develop.
var productTaskDevelopColumns = ProductTaskDevelopColumns{
	Id:                  "id",
...
func NewProductTaskDevelopDao() *ProductTaskDevelopDao {
	return &ProductTaskDevelopDao{
		group:   "default",
		table:   "cqgf_product_task_develop",
		columns: productTaskDevelopColumns,
	}
}
...
func (dao *ProductTaskDevelopDao) Columns() ProductTaskDevelopColumns {
	return dao.columns
}
...
func (dao *ProductTaskDevelopDao) Ctx(ctx context.Context) *gdb.Model {
