...
type ProductTaskProduceDao struct {
	...
	columns ProductTaskProduceColumns // columns contains all the column names of Table for convenient usage.
}
...
// productTaskProduceColumns holds the columns for table cqgf_product_task_produce.
var productTaskProduceColumns = ProductTaskProduceColumns{
	Id:                  "id",
...
func NewProductTaskProduceDao() *ProductTaskProduceDao {
	return &ProductTaskProduceDao{
		group:   "default",
		table:   "cqgf_product_task_produce",
		columns: productTaskProduceColumns,
	}
}
...
func (dao *ProductTaskProduceDao) Columns() ProductTaskProduceColumns {
	return dao.columns
}
...
func (dao *ProductTaskProduceDao) Ctx(ctx context.Context) *gdb.Model {
