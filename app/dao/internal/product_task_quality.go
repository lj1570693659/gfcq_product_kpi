...
type ProductTaskQualityDao struct {
	...
	columns ProductTaskQualityColumns // columns contains all the column names of Table for convenient usage.
}
...
// productTaskQualityColumns holds the columns for table cqgf_product_task_quality.
var productTaskQualityColumns = ProductTaskQualityColumns{
	Id:                  "id",
...
func NewProductTaskQualityDao() *ProductTaskQualityDao {
	return &ProductTaskQualityDao{
		group:   "default",
		table:   "cqgf_product_task_quality",
		columns: productTaskQualityColumns,
	}
}
...
func (dao *ProductTaskQualityDao) Columns() ProductTaskQualityColumns {
	return dao.columns
}
...
func (dao *ProductTaskQualityDao) Ctx(ctx context.Context) *gdb.Model {
