...
// internalProductTaskNpiDao is internal type for wrapping internal DAO implements.
type internalProductTaskNpiDao = *internal.ProductTaskNpiDao

// productTaskNpiDao is the data access object for table cqgf_product_task_npi.
// You can define custom methods on it to extend its functionality as you wish.
type productTaskNpiDao struct {
	internalProductTaskNpiDao
}

var (
	// ProductTaskNpi is globally public accessible object for table cqgf_product_task_npi operations.
	ProductTaskNpi = productTaskNpiDao{
		internal.NewProductTaskNpiDao(),
	}
)
...
func (s *productTaskNpiDao) GetAll(ctx context.Context, in *entity.ProductTaskNpi) (res []*model.ProductTaskNpiField, err error) {
	res = make([]*model.ProductTaskNpiField, 0)
	query := s.Ctx(ctx)
	// 项目经理投入程度
	if in.Id > 0 {
...
func (s *productTaskNpiDao) GetUpgradeAll(ctx context.Context, in *entity.ProductTaskNpi) (res []*model.ProductTaskNpiField, err error) {
	res = make([]*model.ProductTaskNpiField, 0)
...
func (s *productTaskNpiDao) GetList(ctx context.Context, in *model.ProductTaskWhere) (res *response.GetListResponse, err error) {
	res = &response.GetListResponse{}
	resData := make([]*model.ProductTaskNpiField, 0)
...
func (s *productTaskNpiDao) GetOne(ctx context.Context, in *model.ProductTaskWhere) (res model.ProductTaskNpiField, err error) {
	productEntity := model.ProductTaskNpiField{}
	query := s.Ctx(ctx)
	// 项目名称
	if len(in.TaskName) > 0 {
...
// Modify 编辑项目基础数据
func (s *productTaskNpiDao) Modify(ctx context.Context, in model.ProductTaskNpiField) (model.ProductTaskNpiField, error) {
	data := do.ProductTaskNpi{}
