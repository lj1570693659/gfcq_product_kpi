...
// internalProductTaskProduceDao is internal type for wrapping internal DAO implements.
type internalProductTaskProduceDao = *internal.ProductTaskProduceDao
...
type productTaskProduceDao struct {
	internalProductTaskProduceDao
}

var (
	// ProductTaskProduce is globally public accessible object for table cqgf_product_task_produce operations.
	ProductTaskProduce = productTaskProduceDao{
		internal.NewProductTaskProduceDao(),
	}
)

// Fill with you ideas below.
func (s *productTaskProduceDao) GetAll(ctx context.Context, in *entity.ProductTaskProduce) (res []*model.ProductTaskProduceField, err error) {
	res = make([]*model.ProductTaskProduceField, 0)
	query := s.Ctx(ctx)
	// 项目经理投入程度
	if in.Id > 0 {
...
func (s *productTaskProduceDao) GetUpgradeAll(ctx context.Context, in *entity.ProductTaskProduce) (res []*model.ProductTaskProduceField, err error) {
	res = make([]*model.ProductTaskProduceField, 0)
...
func (s *productTaskProduceDao) GetList(ctx context.Context, in *model.ProductTaskWhere) (res *response.GetListResponse, err error) {
	res = &response.GetListResponse{}
	resData := make([]*model.ProductTaskProduceField, 0)
...
func (s *productTaskProduceDao) GetOne(ctx context.Context, in *model.ProductTaskWhere) (res model.ProductTaskProduceField, err error) {
	productEntity := model.ProductTaskProduceField{}
	query := s.Ctx(ctx)
	// 项目名称
	if len(in.TaskName) > 0 {
...
// Modify 编辑项目基础数据
func (s *productTaskProduceDao) Modify(ctx context.Context, in model.ProductTaskProduceField) (model.ProductTaskProduceField, error) {
	data := do.ProductTaskProduce{}
